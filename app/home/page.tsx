        ...
        <div className="flex flex-col px-4 pt-2 gap-2.5" style={{ minHeight: "calc(100svh - 70px)" }}>
          ...
          <div className="flex gap-2.5 items-start animate-fade-in stagger-2 flex-1">
            ...
            <div className="flex flex-col gap-2 flex-1 min-w-0">
              ...
              {/* Settings button — bottom left below the 4 buttons */}
              <Link href="/manage"
                className="flex items-center gap-1.5 text-white/30 hover:text-white/60 interactive transition-colors px-1">
