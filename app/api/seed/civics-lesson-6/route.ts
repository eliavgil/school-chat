...
const slides: Slide[] = [
  // ── שקף 1: פתיחה – כותרת השיעור ──────────────────────────────────────────
  {
    ...
    body: `**נסיכות סילנד**: דגל, מטבע ודרכון משלה — הכול על אסדת בטון נטושה בים הצפוני.
מדינה? כמעט כל העולם אומר לא. אז מה בעצם כן קובע?`,
