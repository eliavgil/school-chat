...
> החוק מסתמך על עקרונות המופיעים כבר במגילת העצמאות.`,
  ...
  // ── שקף 10: הגדרות (להעתקה למחברת) — זהות וסמלים ────────────────────────────
  {
    id: "s10",
    order: 10,
    type: "definitions",
    eyebrow: "מושגים למבחן: זהות המדינה",
    title: "חוק הלאום — זהות וסמלים (מחוון 2017)",
    questions: [
  ...
  // ── שקף 11: הגדרות (להעתקה למחברת) — עלייה והתיישבות ────────────────────────
  {
    id: "s10b",
    order: 11,
    type: "definitions",
    eyebrow: "מושגים למבחן: עלייה והתיישבות",
    title: "חוק הלאום — עלייה, התיישבות ולוח שנה (מחוון 2017)",
    questions: [
