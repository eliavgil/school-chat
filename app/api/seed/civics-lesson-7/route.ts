...
> דמוקרטיה במובן זה אינה מסתפקת בבחירות, אלא שואפת להגן על כבודו של כל אדם באשר הוא אדם, גם אם הוא שייך למיעוט.`,
  ...
  // ── שקף 5.5: הקניה — תקופת הנאורות ────────────────────────────────────────
  {
    ...
    questions: [
      ...
      { id: "e_3", icon: "quote", text: "שאלת יצר האדם", options: ['פילוסופים החלו לשאול — האם בני האדם "רעים מנעוריהם" וזקוקים ליד חזקה שתשליט סדר, או שהם יצורים מוסריים השואפים לחופש? (מידע חיצוני לצורך הדיון התיאורטי בשיעור.)'], correct_index: null },
    ],
  },
  ...
  // ── שקף 5.7: הקניה — הובס מול לוק ─────────────────────────────────────────
  {
    ...
    questions: [
      { id: "ph1", icon: "shield", text: "תומס הובס (גישה פסימית)", options: ['האמין כי יצר האדם רע ו"מלחמתי". ללא שלטון חזק, בני האדם יפגעו זה בזה ("אדם לאדם זאב"), ולכן עליהם למסור את כל כוחם לשליט יחיד שיבטיח סדר וביטחון. (מידע חיצוני לצורך הרקע התיאורטי.)'], correct_index: null },
