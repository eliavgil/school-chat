...
כדי שהן יהיו דמוקרטיות, חייבים להתקיים 5 תנאים, המיוצגים בראשי התיבות: **כ"ח מש"ה**.`,
  ...
  // ── שקף 10: הגדרות (להעתקה למחברת) ─────────────────────────────────────────
  {
    ...
    order: 10,
    type: "definitions",
    eyebrow: 'מושגים למבחן: כ"ח',
    title: 'תנאי יסוד לבחירות דמוקרטיות — כלליות וחשאיות (כ"ח מש"ה)',
    questions: [
  ...
  // ── שקף 11: הגדרות (להעתקה למחברת) — מש"ה ────────────────────────────────
  {
    id: "s10b",
    order: 11,
    type: "definitions",
    eyebrow: 'מושגים למבחן: מש"ה',
    title: 'תנאי יסוד לבחירות דמוקרטיות — מחזוריות, שוויוניות והתמודדות הוגנת (כ"ח מש"ה)',
    questions: [
