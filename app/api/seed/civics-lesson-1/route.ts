...
כדי שישות תוגדר כמדינה, עליה להחזיק בכל חמשת המרכיבים הללו **בו-זמנית**.`,
  ...
  // ── שקף 8: הגדרות (להעתקה למחברת) ─────────────────────────────────────────
  {
    ...
    order: 8,
    type: "definitions",
    eyebrow: "מושגים למבחן: מדינה ותושביה",
    title: "תנאים לקיומה של מדינה — מדינה, שטח ואוכלוסייה (מחוון 2017)",
    questions: [
  ...
  // ── שקף 9: הגדרות (להעתקה למחברת) — ריבונות, שלטון והכרה ─────────────────────
  {
    id: "s8b",
    order: 9,
    type: "definitions",
    eyebrow: "מושגים למבחן: ריבונות ושלטון",
    title: "תנאים לקיומה של מדינה — ריבונות, שלטון והכרה בינלאומית (מחוון 2017)",
    questions: [
