...
אם החומר הוא תמונה/צילום מסך ויש טקסט או פרטים שקשה לקרוא בבירור (מטושטש, חתוך, זווית לא ברורה) — אל תנחש ואל תשלים מה שלא בטוח. דלג על הפרט הלא ברור, או ציין אותו כ"לא ברור" — לעולם אל תמציא שם, תאריך או מספר שלא באמת מופיע בבירור בחומר. שם שגוי גרוע בהרבה מהיעדר מידע.
