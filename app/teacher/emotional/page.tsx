  ...
  return (
    <div className="min-h-screen bg-black/50 backdrop-blur-sm" dir="rtl">
      <header className="bg-black/30 backdrop-blur-md border-b border-white/10 px-5 header-pt pb-4 flex items-center gap-4 sticky top-0 z-10">
        ...
        <div>
          <h1 className="font-semibold text-lg text-white">מעקב רגשי-חברתי</h1>
          <p className="text-white/40 text-xs">ניטור רווחה רגשית וחברתית של תלמידים</p>
        </div>
      </header>
      <div className="max-w-2xl mx-auto px-4 py-16 flex flex-col items-center gap-4 text-center">
        <span className="text-6xl">💙</span>
        <h2 className="text-white text-xl font-light">מעקב רגשי-חברתי</h2>
        <p className="text-white/40 text-sm max-w-xs">
          כאן תוכל לתעד הערות רגשיות, ניקודי רווחה וסקרים מהירים עבור תלמידים בכיתה.
        </p>
